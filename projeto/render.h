...
// Função para desenhar o jogador, incluindo efeitos de invulnerabilidade ou ataques especiais
...
// Função para desenhar as balas no jogo
...
// Função para desenhar o item e o aviso de item na tela
void draw_item_and_warning(Item *item, Player *player, int game_phase,
                           ALLEGRO_FONT *font_warn);

// Função para desenhar inimigos que atiram, incluindo suas balas
...
// Função para desenhar o boss do jogo, incluindo suas balas e explosões
...
// Função para desenhar o HUD (informações do jogo), incluindo o placar e nome do jogador
